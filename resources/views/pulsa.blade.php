...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 mt-2 mb-1 text-center">
            <h2><i class="fa fa-phone"></i> Buy Pulsa</h2>
        ...
        <div class="col-md-12 mt-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('transaction/pulsa') }}/{{ $data->account }}" method="post">
                        @csrf
                    
                        <div class="form-group row">
                            <label for="nohp" class="col-md-4 col-form-label text-md-right">No HP/Telp</label>
